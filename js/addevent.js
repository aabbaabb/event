	...
	$(document).ready(function() {
		...
		bind = function() {
			$("#attend-method .clickbox").click(function(){
				var index=$(this).parents("#attend-method-wrap").find("#attend-method .clickbox").index($(this));
				if(index==0){
					$("#page3").slideDown();
				}
				else{
			...
			$(".speaker-cat-input .category-item li").on("click",function(){	//自动填充职位
				if($(this).parent().parent().parent().prev().val()!=""){
