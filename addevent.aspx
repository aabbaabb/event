	...
	<div id="container-wrap">
		...
		<div id="container">
			<div id="main-page">
				...
				<li class="alert alert-login">别忘了去登陆哦~</li>	
				...
				<li>
					<div id="enroll-time-intro" class="left">
						<p>报名起止时间</p>
						<p class="necessary">*</p>
					</div>
			...
			<ul id="addition-page" class="page">
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F67042aae4597ab7457c22bec963c12bb' type='text/javascript'%3E%3C/script%3E"));
</script>
